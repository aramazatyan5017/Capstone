...
public class CNFConverter {
    ...
    public static CNFSentence toCNF(Sentence sentence) throws UnsatisfiableException, TautologyException {
        ...
        if (sentence.isLiteral() || sentence.isClause() || sentence.isCnf()) return sentence.convertToCNF();
        ...
        if (info.isLeftDetermined() && info.isRightDetermined()) {
            ...
            else throw new UnsatisfiableException();
            ...
            switch (complexSentence.getConnective()) {
                case OR -> {
                    if (value) {
                        if (complexSentence.isNegated()) throw new UnsatisfiableException();
